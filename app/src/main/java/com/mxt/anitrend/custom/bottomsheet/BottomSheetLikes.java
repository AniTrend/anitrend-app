package com.mxt.anitrend.custom.bottomsheet;
 ...
 */
public class BottomSheetLikes extends BottomSheet implements SheetStateChangeListener {
    ...
    public static BottomSheet newInstance(String title, List<UserSmall> adapter) {
        BottomSheet bottomSheetDialogFragment = new BottomSheetLikes();
    ...
    public void onStart() {
        ...
        mFavourite.setVisible(true);
        mFavourite.setIcon(ContextCompat.getDrawable(getContext(), mList.contains(mPresenter.getAppPrefs().getMiniUser())?R.drawable.ic_favorite_white_24dp:R.drawable.ic_favorite_border_white_24dp));
