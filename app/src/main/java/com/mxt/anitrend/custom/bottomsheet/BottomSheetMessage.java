                ...
                switch (mCallback) {
                    case SheetButtonEvents.CALLBACK_UPDATE_CHECKER:
                        if(mPresenter.getAppPrefs().getRepoVersions().checkAgainstCurrent()) {
                            mPresenter.createAlerter(getActivity(), "Download Info!", "The update file will be saved in your downloads folder.",
                            ...
                            mPresenter.createAlerter(getActivity(), "Update Info!", getString(R.string.app_no_date),
