...
class AboutFragment : FragmentBase<Void, BasePresenter, Void>() {
    private val aboutPage by lazy(LazyThreadSafetyMode.NONE) {
        AboutPage(requireContext())
            ...
            .addItem(
                Element()
                    .setTitle(getString(R.string.text_about_terms_and_conditions))
                ...
                Element()
                    .setTitle(getString(R.string.text_about_code_of_conduct))
                    .setIconDrawable(R.drawable.ic_privacy_grey_600_24dp)
                    .setIntent(
                        Intent(
                            Intent.ACTION_VIEW,
