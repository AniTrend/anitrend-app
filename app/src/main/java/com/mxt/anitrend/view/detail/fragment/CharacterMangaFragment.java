...
public class CharacterMangaFragment extends DefaultFragment<Character> implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static CharacterMangaFragment newInstance(Character result) {
        ...
        CharacterMangaFragment fragment = new CharacterMangaFragment();
    ...
    protected void updateUI() {
        if (model != null) {
            mAdapter = new MangaStaffRoles(model.getManga(), getContext());
