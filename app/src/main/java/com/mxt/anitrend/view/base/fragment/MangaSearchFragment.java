...
public class MangaSearchFragment extends SearchFragment<Series> {
    ...
    public static SearchFragment newInstance(String query) {
        ...
        SearchFragment<Series> mFragment = new MangaSearchFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        mRequestType = AsyncTaskFetch.RequestType.MANGA_SEARCH_REQ;
