...
public class SeriesStaffRoleFragment  extends FragmentBaseList<EntityGroup, List<EntityGroup>, SeriesPresenter> {

    public static SeriesStaffRoleFragment newInstance(Bundle args) {
        SeriesStaffRoleFragment fragment = new SeriesStaffRoleFragment();
    ...
    public void onItemClick(View target, EntityGroup data) {
        switch (target.getId()) {
            case R.id.container:
                ...
                intent.putExtra(KeyUtils.arg_mediaType, ((MediaBase)data).getSeries_type());
