...
/**
 * Created by max on 2017/04/12.
 */
public class UserSearchFragment extends SearchFragment<UserSmall> {
    ...
    public static SearchFragment newInstance(String query) {
        ...
        UserSearchFragment mFragment = new UserSearchFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        mRequestType = AsyncTaskFetch.RequestType.USER_SEARCH_REQ;
