...
public class DownloaderService {
    ...
    /**
     * Handles downloading of new versionBase of AniTrend
     */
    public static void downloadNewVersion(Context context, VersionBase versionBase) {
        ...
        request.setTitle(String.format("AniTrend v%s.apk", versionBase.getVersion()));
        ...
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, String.format("AniTrend v%s.apk", versionBase.getVersion()));
