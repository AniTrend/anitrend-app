...
@Entity
public class SeriesList extends EntityGroup implements Parcelable {
    ...
    public boolean equals(Object obj) {
        if(obj instanceof SeriesList)
            return ((SeriesList)obj).record_id == record_id && ((SeriesList)obj).series_id == series_id;
        else if (obj instanceof Series)
            return ((Series)obj).getId() == series_id;
        else if (obj instanceof SeriesBase)
            return ((SeriesBase)obj).getId() == series_id;
