...
public class Media extends MediaBase {
    ...
    private List<Media> relations;
    private List<Media> relations_manga;
    private List<Media> relations_anime;
    ...
    protected Media(Parcel in) {
        ...
        relations = in.createTypedArrayList(Media.CREATOR);
        relations_manga = in.createTypedArrayList(Media.CREATOR);
        relations_anime = in.createTypedArrayList(Media.CREATOR);
    ...
    public List<Media> getRelations_anime() {
    ...
    public List<Media> getRelations() {
        return relations;
    }

    public List<Media> getRelations_manga() {
