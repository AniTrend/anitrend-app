...
public interface StudioModel {
    ...
    Call<StudioBase> getStudioBase(@Body GraphQueryContainer request);

    @POST("/")
    @GraphQuery("StudioMedia")
    @Headers("Content-Type: application/json")
    Call<ConnectionContainer<PageContainer<MediaBase>>> getStudioMedia(@Body GraphQueryContainer request);
}
