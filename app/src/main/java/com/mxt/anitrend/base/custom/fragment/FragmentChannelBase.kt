...
abstract class FragmentChannelBase :
    ...
    protected val clickListener = object : ItemClickListener<Episode> {
        override fun onItemClick(target: View, data: IntPair<Episode>) {
        ...
        override fun onItemLongClick(target: View, data: IntPair<Episode>) = Unit
    }
}
