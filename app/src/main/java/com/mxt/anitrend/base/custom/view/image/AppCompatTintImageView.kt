 ...
 */
class AppCompatTintImageView @JvmOverloads constructor(
    context: Context,
    ...
    fun setTintDrawable(@DrawableRes drawable: Int, @ColorRes colorTint: Int) {
        setImageDrawable(CompatUtil.getDrawable(context, drawable, colorTint))
    }

    fun setTintDrawableAttr(@DrawableRes drawable: Int, @AttrRes colorAttribute: Int) {
        setImageDrawable(CompatUtil.getDrawableTintAttr(context, drawable, colorAttribute))
    }

    companion object {
        @JvmStatic
        fun setTintDrawable(imageView: AppCompatTintImageView, @DrawableRes drawable: Int) {
