...
class CharacterRepository(
    ...
    private val _mutationEvents = MutableSharedFlow<CharacterMutation>(replay = 1, extraBufferCapacity = 64)
    val mutationEvents: SharedFlow<CharacterMutation> = _mutationEvents.asSharedFlow()
