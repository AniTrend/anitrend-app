...
object Migrations {
    val MIGRATION_101_108 =
        object : Migration(101, 108) {
            @CallSuper
    ...
    val MIGRATION_109_134 =
        object : Migration(109, 134) {
            @CallSuper
            override fun applyMigration(
                context: Context,
                settings: Settings,
    ...
    val MIGRATION_18400_18500 =
        object : Migration(18400, 18500) {
            @CallSuper
            override fun applyMigration(
                context: Context,
                settings: Settings,
    ...
    val MIGRATION_1090700_1090800 =
        object : Migration(1090700, 1090800) {
            @CallSuper
            override fun applyMigration(
                context: Context,
                settings: Settings,
