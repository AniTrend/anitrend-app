...
public interface KeyUtil {
    ...
    MEDIA_BROWSE_REQ = 10, MEDIA_LIST_BROWSE_REQ = 11, MEDIA_LIST_REQ = 12, MEDIA_REVIEWS_REQ = 13,
    ...
    @IntDef({GENRE_COLLECTION_REQ, MEDIA_TAG_REQ,
            ...
            MEDIA_BROWSE_REQ, MEDIA_LIST_BROWSE_REQ, MEDIA_LIST_REQ, MEDIA_REVIEWS_REQ,
