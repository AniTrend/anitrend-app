...
public class SeriesCharacterAdapter extends RecyclerViewAdapter<CharacterSmall> {

    public SeriesCharacterAdapter(List<CharacterSmall> adapter, FragmentActivity context) {
