 ...
 * Series staff roles which includes the staff or actor character involvement
 */
...
public class GroupStaffRoleAdapter extends RecyclerViewAdapter<EntityGroup> {
    ...
    public RecyclerViewHolder<EntityGroup> onCreateViewHolder(ViewGroup parent, @KeyUtils.RecyclerViewType int viewType) {
        ...
        return new SeriesStaffRoleViewHolder(AdapterSeriesStaffRoleBinding.inflate(CompatUtil.getLayoutInflater(parent.getContext()), parent, false));
    }
    ...
    protected class SeriesStaffRoleViewHolder extends RecyclerViewHolder<EntityGroup> {
         ...
         * @param binding
         */
        SeriesStaffRoleViewHolder(AdapterSeriesStaffRoleBinding binding) {
