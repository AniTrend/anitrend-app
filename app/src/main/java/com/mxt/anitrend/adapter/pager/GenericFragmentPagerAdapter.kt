...
class GenericFragmentPagerAdapter(manager: FragmentManager, val titles: Array<String>?, val pagerCount: Int, val listener: Listener) : FragmentPagerAdapter(manager) {
